    ...
    <main className="flex flex-col justify-center items-center text-white gap-10" id='app'>
      ...
      {isModalOpen && isMovieData &&(
        <Modal
          ...
          className="mt-[140px] p-4 shadow-lg mx-auto my-8 w-full max-w-[1240px] rounded-lg border-2 border-[#444141] bg-[#131313] bg-opacity-80 backdrop-blur-sm text-white" // Ajoutez vos classes Tailwind ici
